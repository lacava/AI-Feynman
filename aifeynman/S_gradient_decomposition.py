...
def identify_decompositions(pathdir,filename, model, og_pathdir='', max_subset_size=2, visualize=False):
    ...
    np.savetxt(og_pathdir+"results/gradients_gen_sym_%s" %filename, gradients)
